package com.nemo.sj.gencode.utils;

import com.nemo.sj.gencode.entity.ColumnEntity;
import com.nemo.sj.gencode.entity.TableEntity;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/ServiceInterface.java.vm");
        return templates;
    }
    ...
    public static final String  Mapperxml="Mapper.xml.vm";
    public static final String  ServiceImpl="ServiceImpl.java.vm";
    public static final String  ServiceInterface="ServiceInterface.java.vm";
    /**
     * 获取文件名
     */
    public static String getFileName(String template, String className, String packageName) {
        ...
        if (template.contains(Mapper)) {
            return packagePath + "entity" + File.separator + className + "Mapper.java";
        }
        if (template.contains(Mapperxml)) {
            return packagePath + "mapper" + File.separator + className + "Mapper.xml";
        }

        if (template.contains(ServiceInterface)) {
            return packagePath + "service" + File.separator + className + "ServiceInterface.java";
        }
